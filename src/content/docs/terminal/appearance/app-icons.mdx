...
title: 自定义应用图标
description: >-
  从内置应用图标中选择，自定义 Warp 在 macOS 上的 Dock 外观。
---
...
:::note
应用图标仅适用于 macOS 上的 Warp。该功能不支持自定义 Dock 图标。
:::

## 如何更改应用图标

* 前往 **Settings** > **Appearance** > **Icon** > **Customize your app icon**
* 从下拉菜单中选择所需的 Dock 图标
